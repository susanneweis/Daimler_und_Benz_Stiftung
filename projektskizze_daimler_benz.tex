...
\midrule
Personnel & 1 Doctoral Researcher (65\% position, 33 months, DFG rate 6,800 €) & 145,860 \\
Travel    & Included in institutional support & -- \\
Materials & fMRI scanning and infrastructure provided by host institute (letter of intent attached) & -- \\
\midrule
\textbf{Total} & & \textbf{145,860} \\
\bottomrule
\end{tabularx}

\vspace{2em}

\textbf{Co-funding commitment:} In case of funding of the present proposal, the institute commits to 
covering the doctoral researcher’s remaining three months of salary to complete a full 3-year contract, 
as well as the ongoing costs of fMRI scanning
