...
In this \textbf{WP}, we extend beyond RS by examining sustained FC patterns evoked by complex movie narratives. 
...
Thus, this \textbf{WP} will provide insights into which kinds of complex situations elicit the strongest sex differences in 
brain networks. 
By focusing on the brain “in action,” we aim to capture sex differences in the overall experience of 
complex situations — an approach that is fundamentally different from both TB studies 
...
Higher accuracies during NV-AS relative to RS indicate that sex differences emerge more strongly when the brain 
is “in action” rather than in RS.\\  
In addition, the spatial distribution of highly discriminative parcels in NV-AS will highlight the brain 
