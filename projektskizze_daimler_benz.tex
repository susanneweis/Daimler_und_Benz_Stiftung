...
Methodologically, fMRI data will again be parcellated, and region-wise time courses used to compute 
...
will first employ a PCA approach for dimensionality reduction. Then, for each time
