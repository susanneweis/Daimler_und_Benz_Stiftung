...
\textbf{WP1} will extend existing RS findings by examining sustained FC during NV over time windows of several minutes. 
Using a temporally aggregated FC approach, similar to that applied in RS research, this work will identify sex differences 
in “action brain states” and the networks that support them.\\
\textbf{WP} will build on \textbf{WP1} by applying a time-resolved FC approach to detect specific narrative events that 
trigger sex differences in the experience of complex situations. By leveraging detailed annotations of the movie content, we will 
determine which types of scenes produce the strongest sex differences and uncover sex-specific cognitive strategies for processing them.\\
\textbf{WP3} will shift the focus from connectivity to direct brain activation patterns, examining how typical female and male 
responses emerge during evolving movie narratives. This analysis will enrich \textbf{WP1} and \textbf{WP2} by showing how women's 
and men's brains respond differently to unfolding narrative events.
